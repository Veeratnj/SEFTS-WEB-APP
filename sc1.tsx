...
//   const [nseStocks, setNseStocks] = useState<Stock[]>([]);
//   const [optionsStocks, setOptionsStocks] = useState<Stock[]>([]);
...
//         setNseStocks(nseData.data);      // assuming it's an array of stock objects
